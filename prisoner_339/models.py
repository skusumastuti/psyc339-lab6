...
class Player(BasePlayer):
    ...
    participant_name = models.CharField(verbose_name='Please enter your name', widget=widgets.TextInput(), default='')
    res = models.CharField(default='')
    others = models.CurrencyField()
    ...
    def set_payoff(self):
        ...
        self.others = (points_matrix[self.other_player().decision]
                       [self.decision])
